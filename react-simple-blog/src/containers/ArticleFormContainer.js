...
class ArticleFormContainer extends Component {
  constructor(props) {
    ...
    this.handleNewTitleField = this.handleNewTitleField.bind(this);
    this.handleNewBodyField = this.handleNewBodyField.bind(this);
    this.handleSubmit = this.handleSubmit.bind(this);
  }

  handleNewTitleField(event) {
    this.setState({ articleTitle: event.target.value });
  }

  handleNewBodyField(event) {
    ...
    return(
      <form className="new-article-form callout" onSubmit={this.handleSubmit}>
        <TitleField
          ...
          label="Article Title"
          name="article-title"
          handleNew={this.handleNewTitleField}
        />
        <BodyField
          content={this.state.articleBody}
          label="Article Body"
          name="article-body"
          handleNew={this.handleNewBodyField}
        />
