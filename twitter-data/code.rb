...
twitter_data.each do |hash|
  hash.each do |username, bio|
    if bio["description"] != nil
...
#PART 2:
puts "Username and Followers:"
twitter_data.each do |hash|
  hash.each do |username, follow|
    if follow["number of followers"] != nil
      followers = follow["number of followers"]
      name = username
    puts "#{name}: #{followers}"
    end
  end
...
#PART 3:
puts "Username and Length of latest tweet:"
twitter_data.each do |hash|
  hash.each do |username, last|
    if last["latest tweet"] != nil
      latest = last["latest tweet"].length
      name = username
    puts "#{name}: #{latest} characters long."
    end
  end
end

#PART 4:
puts "Username & char count of last 20 tweets:"
total = 0
twitter_data.each do |hash|
  hash.each do |username, twenty|
    if twenty["last twenty tweets"] != nil
      latest = twenty["last twenty tweets"]
      name = username
    latest.each do |char|
      total += char.length
      end
      puts "#{name} used #{total} characters in their last twenty tweets."
    end
  end
end
...
puts "Which User Has The Most Followers:"
total = 0
winner = " "
twitter_data.each do |hash|
 hash.each do |username, follow|
   if follow["number of followers"] > total
     total = follow["number of followers"]
     winner = username
   end
  end
end
puts "#{winner} has the most followers at #{total}"

puts "Which User Has The Most Friends:"
total = 0
winner = " "
twitter_data.each do |hash|
 hash.each do |username, friend|
   if friend["number of friends"] > total
     total = friend["number of friends"]
     winner = username
   end
  end
end
puts "#{winner} has the most friends at #{total}"

puts "Which User Has The Greatest Number of Tweets:"
total = 0
winner = " "
twitter_data.each do |hash|
 hash.each do |username, tweet|
   if tweet["number of tweets"] > total
     total = tweet["number of tweets"]
     winner = username
   end
  end
end
 puts "#{winner} has the greatest number of tweets at #{total}"

puts "Users that do not have a description:"
twitter_data.each do |hash|
  hash.each do |username, bio|
    if bio["description"] == nil
...
puts "Has a Location:"
twitter_data.each do |hash|
  hash.each do |username, home|
    if home["location"] != nil
